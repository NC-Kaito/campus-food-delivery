...
class LocationOrderMember extends StatefulWidget {
  ...
  @override
  State createState() => _LocationOrderMemberState();
}

class _LocationOrderMemberState extends State {
  ...
  // 🎯 1. เพิ่ม GlobalKey สำหรับใช้งาน Validation ของ Form
  ...
  void _confirmLocation() {
    ...
    // 🎯 2. สั่งรัน Validator ของฟอร์ม ถ้ายังไม่กรอกรายละเอียด กรอบแดงจะขึ้นและจะหยุดฟังก์ชัน
    if (!_formKey.currentState!.validate()) {
      return; // 🛑 หยุด ไม่ส่งค่ากลับ
    }

    // 🎯 3. ส่งค่ากลับไปยังหน้า ViewOrderMember
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            child: SafeArea(
              // 🎯 2. ใช้ Form ครอบส่วน UI ที่มี TextField
              child: Form(
                key: _formKey,
                child: Column(
                  ...
                  children: [
                    ...
                    // 🎯 3. เปลี่ยนจาก TextField เป็น TextFormField
                    TextFormField(
                      ...
                      validator: (value) {
                        if (value == null || value.trim().isEmpty) {
                          return 'กรุณาระบุรายละเอียดที่อยู่จัดส่ง';
                        }
                        return null;
                      },
                      decoration: InputDecoration(
                        ...
                        // 🎯 4. จัดการเส้นขอบสีแดงตอน Validation Failed
                        ...
                        Expanded(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed:
                                  _confirmLocation, // 🎯 เรียกฟังก์ชันนี้
