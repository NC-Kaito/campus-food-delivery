...
class _EditAddonState extends State<EditAddon> {
  ...
  // 🎯 ปรับกรอบและเพิ่มสีแจ้งเตือน Error สำหรับข้อมูลทั่วไป
  ...
  Widget _buildAddonRow(int index) {
    ...
    return Container(
      ...
      child: Row(
        // 🎯 ใช้ CrossAxisAlignment.start เพื่อให้ Error text ไม่ดัน UI ให้เสียทรง
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  fillColor: _isEditMode
                      ? _AddonTheme.surface
                      : Colors.transparent,
                  // 🎯 ตัวหนังสือและขอบสีแดงเวลาแจ้งเตือน
          ...
          Expanded(
            ...
            child: TextFormField(
              ...
              readOnly: !_isEditMode,
              // 🎯 ดักจับราคาห้ามว่าง และบังคับให้เป็นตัวเลขเท่านั้น
              validator: (value) {
          ...
          Padding(
            padding: const EdgeInsets.only(
              top: 2,
            ), // ขยับลงมาให้ตรงกับกล่องกรอกข้อมูล
            child: _isEditMode
                ? Row(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Form(
        key: formKey,
        // 🎯 เปิดใช้งานเช็คข้อมูลแบบ Realtime
