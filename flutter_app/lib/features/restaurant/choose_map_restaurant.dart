...
class ChooseMapRestaurant extends StatefulWidget {
  const ChooseMapRestaurant({super.key});

  @override
  State<ChooseMapRestaurant> createState() => _ChooseMapRestaurantState();
}

class _ChooseMapRestaurantState extends State<ChooseMapRestaurant> {
